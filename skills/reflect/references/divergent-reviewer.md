...
- `Read` tool calls against any `SKILL.md` file (workspace `.agents/skills/`, `.claude/skills/`, or `.cursor/skills/`; user-level `~/.agents/skills/`, `~/.claude/skills/`, or `~/.cursor/skills/`; or plugin-installed paths)
